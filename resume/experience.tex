...
\begin{cventries}
\cventry{
        Trading and MarketPlace Development Team
    }
    ...
    {
      \begin{cvitems}
        \item {Building next generation low-latency exchange and matching engine using C++}
        \item {Exposing API for MarketPlace Team}
        \item {Highly scalable application using Akka Actor Framework}
      \end{cvitems}
    }
\cventry{
