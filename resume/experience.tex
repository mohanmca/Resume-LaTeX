...
\begin{cventries}
\cventry{
	    CIB - Macro eTrading Execution and Digital Post Trade Technology
    }
    ...
    {Dec. 2018 - Current}
    {
      \begin{cvitems}
        ...
        \item {Enriched security of platform (using ELK/Grafana/Jaeger) with technology stack of Spring Boot, React, Kafka, ElasticSearch and Apache Cassandra.}
        \item {Built margin call investigation portal with ticket matching and un-structured data reconciliation (using DAG), Drools and Camunda.}
