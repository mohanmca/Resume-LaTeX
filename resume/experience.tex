...
\cventry{
    ...
    {
      \begin{cvitems}
	\item {Worked alongside team of 5-7 developers and 3-5 QA personnel on backend infrastructure}
        \item {Designed new feature to allow token based authentication with Azure SQL using Azure Active Directory}
        \item {Documented existing functionality and source code for client}
