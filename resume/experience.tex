...
\cventry{
    ...
    {Principal MACS SRE Tools Developer | Vice President }
    {JP Morgan|Singapore}
    {Dec. 2018 - Current}
    {
      \begin{cvitems}
        ...
        \item {Built or improved applications (using ELK/Grafana/Jaeger) with technology stack of Spring Boot, ElasticSearch and Apache Cassandra.}
      \end{cvitems}
    }
\cventry{
	    Reference Data-GMOT
