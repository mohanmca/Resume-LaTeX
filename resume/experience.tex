...
\cventry{
    ...
    {Sr Lead Software Engineer | Macro eTrading Rates Derivatives | Margin and Collateral APAC | Vice President }
    {JP Morgan|Singapore}
    {Dec. 2018 - Current}
    {
      \begin{cvitems}
        \item {Managing Margin and Collateral APAC development from Singapore}
...
\cventry{
    ...
    {
      \begin{cvitems}
        \item {Managing APAC client reference data application development team from Singapore}
